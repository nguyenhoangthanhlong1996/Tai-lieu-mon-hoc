...
@endsection
 {{-- Tiêu đề --}} 
@section('title')
<h1><i class="fas fa-plus"></i> Câu hỏi</h1>
@endsection
 {{-- Nội dung chính --}} 
@section('content')
<hr>
	...
	<div class="span12">
		<div class="widget-box">
			...
			<div class="widget-content">
				<form action="{{route('admin.question.store')}}" method="post" class="form-horizontal">
					{{ csrf_field() }}
					...
					<div class="control-group">
						...
						<div class="controls">
							<textarea name="content" rows="8" class="span10" placeholder="Nhập nội dung câu hỏi">{{old('content')}}</textarea>
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">Ghi chú</label>
						<div class="controls">
							<textarea name="note" rows="2" class="span10" placeholder="Nhập nội dung ghi chú">{{old('note')}}</textarea>
						</div>
					</div>
					<div class="control-group">
