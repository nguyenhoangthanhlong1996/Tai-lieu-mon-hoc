...
var ComfirmDialogComponent = /** @class */ (function () {
    function ComfirmDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    ComfirmDialogComponent.prototype.onAgree = function () {
        this.dialogRef.close(true);
    };
    ComfirmDialogComponent.prototype.ngOnInit = function () {
    };
...
var API_END_POINT = 'http://localhost/shopapp/api/admin/';
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, formBuilder, authService, matDialog) {
        this.router = router;
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authService.login(this.formLogin.value)
            ...
            if (response.code === 401) {
                var alertData = { content: 'Tên tài khoản hoặc mật khẩu không đúng', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AlertDialogComponent"], {
                    data: alertData
                });
            }
...
var CategoryCreateComponent = /** @class */ (function () {
    function CategoryCreateComponent(router, formBuilder, categoryService, matDialog) {
        this.router = router;
        this.formBuilder = formBuilder;
    ...
    CategoryCreateComponent.prototype.onSubmit = function () {
        ...
        this.categoryService.create(this.formCategory.value)
            ...
            if (response.code === 500) {
                var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
            else if (response.code === 200) {
                _this.formCategory.reset({
                    name: '',
                    note: ''
                });
                var alertData = { content: 'Tạo danh mục thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
...
var CategoryEditComponent = /** @class */ (function () {
    function CategoryEditComponent(activatedRoute, categoryService, matDialog, router, formBuilder) {
    ...
    CategoryEditComponent.prototype.ngOnInit = function () {
        ...
        this.categoryService.detail(id)
            ...
            if (response.code === 200) {
                var categoryDetail = response.data;
                // Gán các giá trị lên form
                _this.formCategory.get('id').setValue(categoryDetail.id);
                _this.formCategory.get('name').setValue(categoryDetail.name);
                _this.formCategory.get('note').setValue(categoryDetail.note);
            }
    ...
    CategoryEditComponent.prototype.onSubmit = function () {
        ...
        this.categoryService.update(this.formCategory.value)
            ...
            if (response.code === 500) {
                ...
                var alertData = { content: 'Sửa danh mục thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
...
var CategoryListComponent = /** @class */ (function () {
    function CategoryListComponent(categoryService, matDialog, router) {
        this.categoryService = categoryService;
        this.matDialog = matDialog;
        this.router = router;
        this.dtOptions = {};
    ...
    CategoryListComponent.prototype.rerender = function () {
        var _this = this;
        if (this.dtElement.dtInstance instanceof Promise) {
            this.dtElement.dtInstance.then(function (dtInstance) {
                // Destroy the table first
                dtInstance.destroy();
                _this.categoryService.list()
                    .subscribe(function (response) {
                    if (response.code === 200) {
                        _this.listCategories = response.data;
    ...
    CategoryListComponent.prototype.remove = function (id) {
        var _this = this;
        var confirmData = {
        ...
        var dialogRef = this.matDialog.open(_comfirm_dialog_comfirm_dialog_component__WEBPACK_IMPORTED_MODULE_9__["ComfirmDialogComponent"], {
            data: confirmData
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result === true) {
                _this.categoryService.remove(id)
                    .subscribe(function (response) {
                    if (response.code === 500) {
                        var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].ERROR };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                            data: alertData
                        });
                    }
                    else if (response.code === 200) {
                        var alertData = { content: 'Xóa danh mục thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].SUCESS };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                            data: alertData
                        });
                        _this.router.navigate(['/category-list']);
...
var CompanyInfoChangeComponent = /** @class */ (function () {
    function CompanyInfoChangeComponent(router, formBuilder, companyInfoService, matDialog) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.companyInfoService = companyInfoService;
        this.matDialog = matDialog;
    }
    CompanyInfoChangeComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Thiếp lập form
        ...
        this.companyInfoService.get()
            ...
            if (response.code === 200) {
                ...
                // Gán các giá trị lên form
                _this.formCompanyInfoChange.get('name').setValue(companyInfo.name);
                _this.formCompanyInfoChange.get('aboutContent').setValue(companyInfo.about_content);
                _this.formCompanyInfoChange.get('address').setValue(companyInfo.address);
                _this.formCompanyInfoChange.get('email').setValue(companyInfo.email);
                _this.formCompanyInfoChange.get('website').setValue(companyInfo.website);
                _this.formCompanyInfoChange.get('hotline').setValue(companyInfo.hotline);
            }
            else if (response.code === 404) {
                var alertData = { content: 'Không có thông tin', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
    ...
    CompanyInfoChangeComponent.prototype.onSubmit = function () {
        var _this = this;
        this.companyInfoService.change(this.formCompanyInfoChange.value)
            .subscribe(function (response) {
            if (response.code === 200) {
                var alertData = { content: 'Sửa thông tin công ty thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
    ...
    return CompanyInfoChangeComponent;
}());
...
/* harmony import */ var ckeditor4_angular__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ckeditor4-angular */ "./node_modules/ckeditor4-angular/fesm5/ckeditor4-angular.js");
...
var ProductCreateComponent = /** @class */ (function () {
    function ProductCreateComponent(router, formBuilder, categoryService, unitService, productService, matDialog) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.categoryService = categoryService;
    ...
    ProductCreateComponent.prototype.ngOnInit = function () {
        ...
        this.categoryService.list()
            .subscribe(function (response) {
            if (response.code === 200) {
                var mappedData = response.data.map(function (item) { return ({ id: item.id, text: item.name }); });
                mappedData.unshift({ id: '', text: '--Chọn--' });
                _this.listCategories = mappedData;
            }
        }, function (error) {
            console.log(error);
        });
        ...
        this.unitService.list()
            ...
            if (response.code === 200) {
                var mappedData = response.data.map(function (item) { return ({ id: item.id, text: item.name }); });
                mappedData.unshift({ id: '', text: '--Chọn--' });
                _this.listUnits = mappedData;
            }
        }, function (error) {
            console.log(error);
        });
    };
    ProductCreateComponent.prototype.chooseCoverImage = function (event) {
        var _this = this;
        ...
        reader.onload = function (evt) {
            _this.formProduct.get('coverImage').setValue(evt.target.result);
        };
        reader.readAsDataURL(file);
    };
    ProductCreateComponent.prototype.removeCoverImage = function () {
    ...
    ProductCreateComponent.prototype.onSubmit = function () {
        ...
        this.productService.create(this.formProduct.value)
            .subscribe(function (response) {
            if (response.code === 500) {
                var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_6__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_7__["AlertDialogComponent"], {
                    data: alertData
                });
            }
            else if (response.code === 200) {
                _this.formProduct.reset({
                    categoryId: '',
                    unitId: '',
                    name: '',
                    price: '',
                ...
                var alertData = { content: 'Tạo sản phẩm thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_6__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_7__["AlertDialogComponent"], {
                    data: alertData
                });
            }
    ...
    ProductCreateComponent.prototype.selectCategoryChange = function (e) {
        this.formProduct.get('categoryId').setValue(e.value);
    };
    ProductCreateComponent.prototype.selectUnitChange = function (e) {
...
var ProductEditComponent = /** @class */ (function () {
    function ProductEditComponent(activatedRoute, router, formBuilder, categoryService, unitService, productService, matDialog) {
        this.activatedRoute = activatedRoute;
        this.router = router;
        this.formBuilder = formBuilder;
        this.categoryService = categoryService;
    ...
    ProductEditComponent.prototype.ngOnInit = function () {
        ...
        this.productService.detail(id)
            .subscribe(function (response) {
            if (response.code === 200) {
                var productDetail_1 = response.data;
                // Lấy danh sách danh mục
                _this.categoryService.list()
                    .subscribe(function (response1) {
                    if (response.code === 200) {
                        var mappedData = response1.data.map(function (item) { return ({ id: item.id, text: item.name }); });
                        mappedData.unshift({ id: '', text: '--Chọn--' });
                        _this.listCategories = mappedData;
                        _this.formProduct.get('categoryId').setValue(productDetail_1.category_id);
                    }
                }, function (error) {
                    console.log(error);
                });
                // Lấy danh sách đơn vị tính
                _this.unitService.list()
                    .subscribe(function (response2) {
                    if (response.code === 200) {
                        var mappedData = response2.data.map(function (item) { return ({ id: item.id, text: item.name }); });
                        mappedData.unshift({ id: '', text: '--Chọn--' });
                        _this.listUnits = mappedData;
                        _this.formProduct.get('unitId').setValue(productDetail_1.unit_id);
                    }
                }, function (error) {
                    console.log(error);
                });
                // Gán các giá trị lên form
                _this.formProduct.get('id').setValue(productDetail_1.id);
                _this.formProduct.get('name').setValue(productDetail_1.name);
                _this.formProduct.get('price').setValue(productDetail_1.price);
                _this.formProduct.get('quantityRemaining').setValue(productDetail_1.quantity_remaining);
                _this.formProduct.get('outOfStockFlag').setValue(!!+productDetail_1.out_of_stock_flag);
                _this.formProduct.get('description').setValue(productDetail_1.description);
                _this.formProduct.get('posts').setValue(productDetail_1.posts);
                _this.formProduct.get('tags').setValue(productDetail_1.tags);
                _this.formProduct.get('coverImage').setValue(productDetail_1.cover_image);
            }
            else if (response.code === 404) {
                _this.router.navigate(['/page-not-found']);
            }
            else {
                var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_8__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AlertDialogComponent"], {
                    data: alertData
                });
            }
        }, function (error) {
    ...
    ProductEditComponent.prototype.chooseCoverImage = function (event) {
        var _this = this;
        this.currentEventCoverImage = event;
        var fileList = event.target.files;
        var file = fileList.item(0);
    ...
    ProductEditComponent.prototype.removeCoverImage = function () {
        if (this.currentEventCoverImage !== undefined) {
            this.currentEventCoverImage.srcElement.value = null;
        }
        this.formProduct.get('coverImage').setValue('');
    ...
    ProductEditComponent.prototype.onSubmit = function () {
        ...
        this.productService.update(this.formProduct.value)
            ...
            if (response.code === 500) {
                ...
                var alertData = { content: 'Sửa sản phẩm thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_8__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AlertDialogComponent"], {
                    data: alertData
                });
    ...
    ProductEditComponent.prototype.selectCategoryChange = function (e) {
        this.formProduct.get('categoryId').setValue(e.value);
    };
    ProductEditComponent.prototype.selectUnitChange = function (e) {
        this.formProduct.get('unitId').setValue(e.value);
    };
...
var ProductInfoDialogComponent = /** @class */ (function () {
    function ProductInfoDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    ProductInfoDialogComponent.prototype.ngOnInit = function () {
    };
    ...
    return ProductInfoDialogComponent;
}());
...
var ProductListComponent = /** @class */ (function () {
    function ProductListComponent(productService, matDialog, router) {
        this.productService = productService;
        this.matDialog = matDialog;
        this.router = router;
        this.dtOptions = {};
    ...
    ProductListComponent.prototype.rerender = function () {
        ...
        if (this.dtElement.dtInstance instanceof Promise) {
            this.dtElement.dtInstance.then(function (dtInstance) {
                // Destroy the table first
                dtInstance.destroy();
                _this.productService.list()
                    .subscribe(function (response) {
                    if (response.code === 200) {
                        _this.listProducts = response.data;
                        // Call the dtTrigger to rerender again
                        _this.dtTrigger.next();
                    }
                }, function (error) {
    ...
    ProductListComponent.prototype.detail = function (id) {
        var _this = this;
        this.productService.detail(id)
            .subscribe(function (response) {
            if (response.code === 200) {
                var productInfoData = response.data;
                console.log(productInfoData);
                var dialogRef = _this.matDialog.open(_product_info_dialog_product_info_dialog_component__WEBPACK_IMPORTED_MODULE_11__["ProductInfoDialogComponent"], {
    ...
    ProductListComponent.prototype.remove = function (id) {
        ...
        var dialogRef = this.matDialog.open(_comfirm_dialog_comfirm_dialog_component__WEBPACK_IMPORTED_MODULE_8__["ComfirmDialogComponent"], {
            data: confirmData
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result === true) {
                _this.productService.remove(id)
                    ...
                    if (response.code === 500) {
                        var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].ERROR };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AlertDialogComponent"], {
                            data: alertData
                        });
                    }
                    else if (response.code === 200) {
                        var alertData = { content: 'Xóa sản phẩm thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].SUCESS };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AlertDialogComponent"], {
                            data: alertData
                        });
                        _this.rerender();
...
var UnitCreateComponent = /** @class */ (function () {
    function UnitCreateComponent(router, formBuilder, unitService, matDialog) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.unitService = unitService;
        this.matDialog = matDialog;
    }
    UnitCreateComponent.prototype.ngOnInit = function () {
        this.formUnit = this.formBuilder.group({
            name: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            note: [''],
        });
    };
    UnitCreateComponent.prototype.onSubmit = function () {
        var _this = this;
        this.unitService.create(this.formUnit.value)
            ...
            if (response.code === 500) {
                ...
                _this.formUnit.reset({
                    name: '',
                    note: ''
                });
                var alertData = { content: 'Tạo đơn vị tính thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
...
var UnitEditComponent = /** @class */ (function () {
    function UnitEditComponent(activatedRoute, unitService, matDialog, router, formBuilder) {
        this.activatedRoute = activatedRoute;
        this.unitService = unitService;
        this.matDialog = matDialog;
        this.router = router;
    ...
    UnitEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Thiết lập form
        this.formUnit = this.formBuilder.group({
            id: [0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        ...
        this.unitService.detail(id)
            .subscribe(function (response) {
            if (response.code === 200) {
                var unitDetail = response.data;
                // Gán các giá trị lên form
                _this.formUnit.get('id').setValue(unitDetail.id);
                _this.formUnit.get('name').setValue(unitDetail.name);
                _this.formUnit.get('note').setValue(unitDetail.note);
            }
            else if (response.code === 404) {
                _this.router.navigate(['/page-not-found']);
            }
    ...
    UnitEditComponent.prototype.onSubmit = function () {
        var _this = this;
        this.unitService.update(this.formUnit.value)
            ...
            if (response.code === 500) {
                ...
                var alertData = { content: 'Sửa đơn vị tính thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_5__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
                _this.router.navigate(['/unit-list']);
            }
        }, function (error) {
            console.log(error);
        });
...
var UnitListComponent = /** @class */ (function () {
    function UnitListComponent(unitService, matDialog, router) {
        this.unitService = unitService;
        this.matDialog = matDialog;
        this.router = router;
        this.dtOptions = {};
    ...
    UnitListComponent.prototype.rerender = function () {
        var _this = this;
        if (this.dtElement.dtInstance instanceof Promise) {
            this.dtElement.dtInstance.then(function (dtInstance) {
                // Destroy the table first
    ...
    UnitListComponent.prototype.edit = function (id) {
        this.router.navigate(['/unit-edit', id]);
    };
    UnitListComponent.prototype.remove = function (id) {
        var _this = this;
        var confirmData = {
            ...
            if (result === true) {
                _this.unitService.remove(id)
                    ...
                    if (response.code === 500) {
                        ...
                        var alertData = { content: 'Xóa đơn vị tính thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].SUCESS };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_9__["AlertDialogComponent"], {
                            data: alertData
                        });
                        _this.router.navigate(['/unit-list']);
...
var UserChangeInfoComponent = /** @class */ (function () {
    function UserChangeInfoComponent(activatedRoute, userService, matDialog, router, formBuilder) {
        this.activatedRoute = activatedRoute;
    ...
    UserChangeInfoComponent.prototype.ngOnInit = function () {
        var _this = this;
        // Thiết lập form
        this.avatarSrc = '';
        ...
        this.userService.detail(username)
            ...
            if (response.code === 200) {
                ...
                // Gán các giá trị lên form
                _this.formChangeUserInfo.get('username').setValue(userDetail.username);
                _this.formChangeUserInfo.get('name').setValue(userDetail.full_name);
                _this.formChangeUserInfo.get('email').setValue(userDetail.email);
                _this.formChangeUserInfo.get('phone').setValue(userDetail.phone);
                _this.formChangeUserInfo.get('address').setValue(userDetail.address);
                _this.formChangeUserInfo.get('avatar').setValue(userDetail.avatar);
            }
            else if (response.code === 404) {
                _this.router.navigate(['/page-not-found']);
            }
            else {
                var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_4__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AlertDialogComponent"], {
                    data: alertData
                });
            }
    ...
    UserChangeInfoComponent.prototype.chooseAvatar = function (event) {
        var _this = this;
        ...
        var reader = new FileReader();
        reader.onload = function (evt) {
            _this.formChangeUserInfo.get('avatar').setValue(evt.target.result);
        };
        reader.readAsDataURL(file);
    };
    UserChangeInfoComponent.prototype.removeAvatar = function () {
        if (this.currentEventAvatar) {
            this.currentEventAvatar.srcElement.value = null;
        }
        this.formChangeUserInfo.get('avatar').setValue('');
    };
    UserChangeInfoComponent.prototype.onSubmit = function () {
        var _this = this;
        this.userService.changeInfo(this.formChangeUserInfo.value)
            ...
            if (response.code === 500) {
                ...
                var alertData = { content: 'Sửa thông tin tài khoản thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_4__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_5__["AlertDialogComponent"], {
                    data: alertData
                });
    ...
    return UserChangeInfoComponent;
}());
...
var UserChangePasswordComponent = /** @class */ (function () {
    function UserChangePasswordComponent(activatedRoute, userService, matDialog, router, formBuilder) {
        this.activatedRoute = activatedRoute;
        this.userService = userService;
        this.matDialog = matDialog;
        this.router = router;
    ...
    UserChangePasswordComponent.prototype.onSubmit = function () {
        ...
        this.userService.changePassword(this.formChangeUserPassword.value)
            ...
            if (response.code === 500) {
                ...
                var alertData = { content: 'Đổi mật khẩu thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_6__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_7__["AlertDialogComponent"], {
                    data: alertData
                });
                _this.router.navigate(['/user-list']);
...
var UserCreateComponent = /** @class */ (function () {
    function UserCreateComponent(router, formBuilder, userService, matDialog) {
        this.router = router;
        this.formBuilder = formBuilder;
        this.userService = userService;
        this.matDialog = matDialog;
    ...
    UserCreateComponent.prototype.chooseAvatar = function (event) {
        var _this = this;
        this.currentEventAvatar = event;
        var fileList = event.target.files;
        var file = fileList.item(0);
        var reader = new FileReader();
        reader.onload = function (evt) {
            _this.formUser.get('avatar').setValue(evt.target.result);
        };
        reader.readAsDataURL(file);
    };
    UserCreateComponent.prototype.removeAvatar = function () {
    ...
    UserCreateComponent.prototype.onSubmit = function () {
        ...
        this.userService.create(this.formUser.value)
            ...
            if (response.code === 500) {
                ...
                _this.removeAvatar();
                var alertData = { content: 'Tạo tài khoản thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].SUCESS };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_6__["AlertDialogComponent"], {
                    data: alertData
                });
            }
...
var UserInfoDialogComponent = /** @class */ (function () {
    function UserInfoDialogComponent(dialogRef, data) {
        this.dialogRef = dialogRef;
        this.data = data;
    }
    UserInfoDialogComponent.prototype.ngOnInit = function () {
    };
    ...
    return UserInfoDialogComponent;
}());
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(userService, matDialog, router) {
        this.userService = userService;
        this.matDialog = matDialog;
        this.router = router;
        this.dtOptions = {};
    ...
    UserListComponent.prototype.rerender = function () {
        var _this = this;
        if (this.dtElement.dtInstance instanceof Promise) {
            this.dtElement.dtInstance.then(function (dtInstance) {
                // Destroy the table first
    ...
    UserListComponent.prototype.showUserInfo = function (username) {
        var _this = this;
        this.userService.detail(username)
            .subscribe(function (response) {
            if (response.code === 200) {
                var userInfoData = response.data;
                var dialogRef = _this.matDialog.open(_user_info_dialog_user_info_dialog_component__WEBPACK_IMPORTED_MODULE_6__["UserInfoDialogComponent"], {
                    data: userInfoData
                });
            }
            else {
                var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].ERROR };
                var dialogRef = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                    data: alertData
                });
            }
        }, function (error) {
    ...
    UserListComponent.prototype.changeUserInfo = function (username) {
        this.router.navigate(['/user-change-info', username]);
    };
    UserListComponent.prototype.changeUserPassword = function (username) {
        this.router.navigate(['/user-change-password', username]);
    };
    UserListComponent.prototype.removeUser = function (username) {
        var _this = this;
        var confirmData = {
            content: "B\u1EA1n c\u00F3 ch\u1EAFc mu\u1ED1n x\u00F3a t\u00E0i kho\u1EA3n '" + username + "' ? (B\u1EA1n s\u1EBD kh\u00F4ng th\u1EC3 kh\u00F4i ph\u1EE5c l\u1EA1i)",
            type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].WARNING
        };
        var dialogRef = this.matDialog.open(_comfirm_dialog_comfirm_dialog_component__WEBPACK_IMPORTED_MODULE_10__["ComfirmDialogComponent"], {
            data: confirmData
        });
        dialogRef.afterClosed().subscribe(function (result) {
            if (result === true) {
                _this.userService.remove(username)
                    .subscribe(function (response) {
                    if (response.code === 500) {
                        var alertData = { content: response.message, type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].ERROR };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                        ...
                        var alertData = { content: 'Xóa tài khoản thành công', type: _enums_DialogType__WEBPACK_IMPORTED_MODULE_7__["DialogType"].SUCESS };
                        var dialogRef1 = _this.matDialog.open(_alert_dialog_alert_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AlertDialogComponent"], {
                            data: alertData
                        });
                        _this.router.navigate(['/user-list']);
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.login = function (frmLogin) {
        var url = _configs_Config__WEBPACK_IMPORTED_MODULE_4__["API_END_POINT"] + 'auth.php?action=login';
    ...
    AuthService.prototype.getUserInfo = function () {
        var url = _configs_Config__WEBPACK_IMPORTED_MODULE_4__["API_END_POINT"] + 'auth.php?action=info';
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.create = function (formCategory) {
        var url = this.urlAPI + 'create';
        return this.http.post(url, formCategory);
    };
    CategoryService.prototype.list = function () {
        var url = this.urlAPI + 'list';
        return this.http.get(url);
    };
    CategoryService.prototype.detail = function (id) {
        var url = this.urlAPI + 'detail';
        return this.http.post(url, { id: id });
    };
    CategoryService.prototype.update = function (formCategory) {
        var url = this.urlAPI + 'update';
        return this.http.post(url, formCategory);
    };
    CategoryService.prototype.remove = function (id) {
        var url = this.urlAPI + 'remove';
        return this.http.post(url, { id: id });
    };
...
var CompanyInfoService = /** @class */ (function () {
    function CompanyInfoService(http, router) {
        this.http = http;
        this.router = router;
        this.urlAPI = '';
        this.urlAPI = _configs_Config__WEBPACK_IMPORTED_MODULE_4__["API_END_POINT"] + 'company-info.php?action=';
    }
    CompanyInfoService.prototype.get = function () {
        var url = this.urlAPI + 'get';
        return this.http.get(url);
    };
    CompanyInfoService.prototype.change = function (formCompanyInfoChange) {
        var url = this.urlAPI + 'change';
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.create = function (formProduct) {
        var url = this.urlAPI + 'create';
    ...
    ProductService.prototype.detail = function (id) {
        var url = this.urlAPI + 'detail';
        return this.http.post(url, { id: id });
    };
    ProductService.prototype.update = function (formProduct) {
        var url = this.urlAPI + 'update';
        return this.http.post(url, formProduct);
    };
...
var TokenInterceptorService = /** @class */ (function () {
    ...
    TokenInterceptorService.prototype.intercept = function (req, next) {
        ...
        return next.handle(tokenizeReq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (evt) {
...
var UnitService = /** @class */ (function () {
    ...
    UnitService.prototype.create = function (formUnit) {
        var url = this.urlAPI + 'create';
        return this.http.post(url, formUnit);
    };
    UnitService.prototype.list = function () {
        var url = this.urlAPI + 'list';
        return this.http.get(url);
    };
    UnitService.prototype.detail = function (id) {
        var url = this.urlAPI + 'detail';
        return this.http.post(url, { id: id });
    };
    UnitService.prototype.update = function (formUnit) {
        var url = this.urlAPI + 'update';
        return this.http.post(url, formUnit);
    };
    UnitService.prototype.remove = function (id) {
        var url = this.urlAPI + 'remove';
        return this.http.post(url, { id: id });
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (formUser) {
        var url = this.urlAPI + 'create';
    ...
    UserService.prototype.detail = function (username) {
        var url = this.urlAPI + 'detail';
        return this.http.post(url, { username: username });
    };
    UserService.prototype.changeInfo = function (formChangeUserInfo) {
        var url = this.urlAPI + 'change-info';
        return this.http.post(url, formChangeUserInfo);
    };
    UserService.prototype.changePassword = function (formChangeUserPassword) {
        var url = this.urlAPI + 'change-password';
