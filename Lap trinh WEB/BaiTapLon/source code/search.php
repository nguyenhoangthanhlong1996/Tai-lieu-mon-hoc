...
if (isset($_GET['key'])) {
    ...
    // List sản phẩm theo từ khóa tìm kiếm
    $listProducts = $productDAO->getListProductsBySearchKey($key);
} else {
            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <div class="beta-products-list">
                        ...
                        <?php if (count($listProducts) == 0) echo "<p class='space50'>Không có sản phẩm nào có chứa từ khóa '$key'</p>"; ?>
                        <div class="row">
                            <?php
